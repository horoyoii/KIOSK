...
QT_MOC_LITERAL(1, 6, 19), // "SiganlUpdateTimerUI"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "time"
QT_MOC_LITERAL(4, 32, 6) // "mCount"

    },
    "Timer\0SiganlUpdateTimerUI\0\0time\0mCount"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Timer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::SiganlUpdateTimerUI)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Timer::SiganlUpdateTimerUI(int _t1)
{
