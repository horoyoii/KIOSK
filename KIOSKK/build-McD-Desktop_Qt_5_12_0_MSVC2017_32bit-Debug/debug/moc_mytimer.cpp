...
QT_MOC_LITERAL(1, 8, 19), // "SiganlUpdateTimerUI"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 1), // "n"
QT_MOC_LITERAL(4, 31, 6), // "mCount"
QT_MOC_LITERAL(5, 38, 4) // "Stop"

    },
    "myTimer\0SiganlUpdateTimerUI\0\0n\0mCount\0"
    "Stop"
};
...
void myTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SiganlUpdateTimerUI((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->mCount(); break;
        ...
        {
            using _t = void (myTimer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myTimer::SiganlUpdateTimerUI)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myTimer::SiganlUpdateTimerUI(int _t1)
{
